      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {[ 
          ...
          <div key={index} className="max-w-sm mx-auto">
            <div className="bg-gradient-to-r from-teal-400 to-blue-500 shadow-lg rounded-lg p-8 text-center flex flex-col items-center justify-between min-h-[250px] hover:scale-105 transition-all duration-300">
